...
class outletorder extends StatefulWidget{
  outletorderstate createState()=>outletorderstate();
}

class outletorderstate extends State<outletorder>{
  bool isError = false;
  ...
  Future<void> getUserorder() async {
    ...
    try {
      final response =
      await http.post(outletorderapi, body: {"outlet_id": "23"});
